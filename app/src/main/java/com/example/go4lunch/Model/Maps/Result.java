...
public class Result implements Serializable
{
    ...
    private final static long serialVersionUID = -2981072181238252158L;
    ...
    public String toString() {
        ...
        sb.append('=');
        sb.append(this.permanentlyClosed);
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+(this.permanentlyClosed? 1 : 0));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((this.types == rhs.types)||((this.types!= null)&&this.types.equals(rhs.types)))&&((this.plusCode == rhs.plusCode)||((this.plusCode!= null)&&this.plusCode.equals(rhs.plusCode))))&&((this.icon == rhs.icon)||((this.icon!= null)&&this.icon.equals(rhs.icon))))&&((this.placeId == rhs.placeId)||((this.placeId!= null)&&this.placeId.equals(rhs.placeId))))&&(Double.doubleToLongBits(this.rating) == Double.doubleToLongBits(rhs.rating)))&&(this.userRatingsTotal == rhs.userRatingsTotal))&&((this.businessStatus == rhs.businessStatus)||((this.businessStatus!= null)&&this.businessStatus.equals(rhs.businessStatus))))&&(this.priceLevel == rhs.priceLevel))&&((this.photos == rhs.photos)||((this.photos!= null)&&this.photos.equals(rhs.photos))))&&((this.iconMaskBaseUri == rhs.iconMaskBaseUri)||((this.iconMaskBaseUri!= null)&&this.iconMaskBaseUri.equals(rhs.iconMaskBaseUri))))&&((this.reference == rhs.reference)||((this.reference!= null)&&this.reference.equals(rhs.reference))))&&(this.permanentlyClosed == rhs.permanentlyClosed))&&((this.iconBackgroundColor == rhs.iconBackgroundColor)||((this.iconBackgroundColor!= null)&&this.iconBackgroundColor.equals(rhs.iconBackgroundColor))))&&((this.scope == rhs.scope)||((this.scope!= null)&&this.scope.equals(rhs.scope))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.geometry == rhs.geometry)||((this.geometry!= null)&&this.geometry.equals(rhs.geometry))))&&((this.openingHours == rhs.openingHours)||((this.openingHours!= null)&&this.openingHours.equals(rhs.openingHours))))&&((this.vicinity == rhs.vicinity)||((this.vicinity!= null)&&this.vicinity.equals(rhs.vicinity))));
    }
